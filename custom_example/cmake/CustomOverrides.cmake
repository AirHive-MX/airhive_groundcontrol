set(QGC_APP_NAME "AirHiveGroundControl" CACHE STRING "App Name" FORCE)

set(QGC_MACOS_ICON_PATH "${CMAKE_SOURCE_DIR}/custom/res" CACHE PATH "MacOS Icon Path" FORCE)
set(QGC_APPIMAGE_ICON_PATH "${CMAKE_SOURCE_DIR}/custom/res/icons/logo_sin_fondo_airhive.png" CACHE FILEPATH "AppImage Icon Path" FORCE)
...
if(EXISTS ${CMAKE_SOURCE_DIR}/custom/deploy/windows/WindowsQGC.ico)
    set(QGC_WINDOWS_ICON_PATH "${CMAKE_SOURCE_DIR}/custom/deploy/windows/logo_sin_fondo_airhive.ico" CACHE FILEPATH "Windows Icon Path" FORCE)
endif()
